  ...
  <div class="m-auto mt-20 w-full max-w-xs">
    <form class="bg-white border shadow-md rounded-md px-8 pt-6 pb-8 mb-4">
      ...
      <div class="mb-4 mt-3">
        ...
        <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="username" type="text" placeholder="example@mail.ru">
      </div>
      <div class="mb-6">
